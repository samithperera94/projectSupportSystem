...
<body>
	...
	<div class="changer" id="formload">
		<div id="progressReport1">
			<form class="form-horizontal" method="POST" action="DoEditProgressReport">
				...
				<div ng-app="myApp" ng-controller="ProgressController">
					<div class="form-group col-sm-12">
						...
						<textarea class="form-control" id="exampleTextarea" rows="3" name="workCarried"
							ng-disabled="state" ng-init="state=true" required>{{progressreport.workCarried}}</textarea>
					</div>
					<div class="form-group col-sm-12">
						<label for="exampleTextarea">Problems Encountered: </label>
						<textarea class="form-control" id="exampleTextarea" rows="3" name="problems"
							ng-disabled="state" ng-init="state=true" required>{{progressreport.problems}}</textarea>
					</div>
					<div class="form-group col-sm-12">
						<label for="exampleTextarea">Planned work that were unable
							to carry out with reasons: </label>
						<textarea class="form-control" id="exampleTextarea" rows="3" name="workPlannedButNotDone"
							ng-disabled="state" ng-init="state=true" required>{{progressreport.workPlannedButNotDone}}</textarea>
					</div>
					<div class="form-group col-sm-12">
						<label for="exampleTextarea">Work planned until next
							meeting: </label>
						<textarea class="form-control" id="exampleTextarea" rows="3" name="workPlanned"
							ng-disabled="state" ng-init="state=true" required>{{progressreport.workPlanned}}</textarea>
					</div>
			...
			<div class="col-sm-9">
				...
				<p class="help-block col-sm-3">"*filename:
					...
					<a class="btn btn-default" href="DoDeleteProgressReport"> Delete</a>
				</div>
			</form>
		</div>
